...
const personContratada = (nome) => ({nomeCompleto: nome, email: nome.toLowerCase().replace(/ /g, '_')+'@trybe.com',});
...
// console.log(personContratada('joAo PacHeco'))

console.log(newEmployees(personContratada))